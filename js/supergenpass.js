/*!
 * This is almost exact copy of SuperGenPass mobile script with a small
 * modification at the very end.
 *
 * A word to SuperGenPass creator:
 *
 * SuperGenPass owes a great debt to Paul Johnston,
 * who wrote the JavaScript implementation of MD5,
 * and to Nic Wolff, who wrote the original bookmarklet password
 * generator.
 * My contributions, such that they are, are released under the GNU
